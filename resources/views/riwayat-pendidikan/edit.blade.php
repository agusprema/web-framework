...
@section('content_header')
    <div class="row">
        ...
        <div class="col text-end">
            <a href="{{ url('riwayat-pendidikan/'. $mhs_id) }}" class="mt-3 btn btn-sm btn-secondary">Kembali</a>
        </div>
    </div>
@stop
        ...
        <div class="row">
            <div class="col-6">
                <div class="mb-3 form-group">
                    ...
                    <select name="jenjang" class="form-control {{ !$errors->has('jenjang') ?: 'is-invalid' }}">
                        @foreach ($dataJenjang as $jenjang)
                            <option {{ $data->jenjang == $jenjang ?: 'selected' }} value="{{ $jenjang->nama }}">{{ $jenjang->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3 form-group">
                    ...
                    <input type="text" name="nama_sekolah" class="form-control {{ !$errors->has('nama_sekolah') ?: 'is-invalid' }}" value="{{ $data->nama_sekolah }}">
                ...
                <div class="mb-3 form-group">
                    ...
                    <input type="text" name="alamat" class="form-control {{ !$errors->has('alamat') ?: 'is-invalid' }}" value="{{ $data->alamat }}">
                ...
                <div class="mb-3 form-group">
                    ...
                    <input type="year" name="tahun_masuk" class="form-control {{ !$errors->has('tahun_masuk') ?: 'is-invalid' }}" value="{{ $data->tahun_masuk }}">
                ...
                <div class="mb-3 form-group">
                    ...
                    <input type="year" name="tahun_lulus" class="form-control {{ !$errors->has('tahun_lulus') ?: 'is-invalid' }}" value="{{ $data->tahun_lulus }}">
